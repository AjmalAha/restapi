...
public class WatchModel {
		...
		public String toString() {
			return "WatchModel [watch_id=" + watch_id + ", watch_Model=" + watch_Model + ", watch_company="
					+ watch_company + ", watch_colour=" + watch_colour + ", watch_price=" + watch_price
					+ ", strap_material=" + strap_material + ", watch_type=" + watch_type + ", watch_warranty="
					+ watch_warranty + ", water_resistance=" + water_resistance + ", watch_additionalfeatures="
					+ watch_additionalfeatures + ", watch_batteryLife=" + watch_batteryLife + "]";
		}
